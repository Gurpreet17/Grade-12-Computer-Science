...
public class Account {
	...
	/**
	 * constructor pre: none post: An account has been created. Balance and customer
	...
	/**
	 * Returns a String that represents the Account object. pre: none post: A string
	 * representing the Account object has been returned.
	 */
